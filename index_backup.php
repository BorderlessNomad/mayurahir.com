        ...
        <div id="container">
            ...
            <div id="header">
                ...
                <div id="right_header">
                    ...
                    <ul class="main_panel">
                        <li><a href="cv.pdf" title="Download CV" class="white"><img src="./img/download.png" width="32" height="32" alt="Download CV" /></a></li>
                        <li><a href="#" title="Print CV" class="print_button white"><img src="./img/print.png" width="32" height="32" alt="Print CV" /></a></li>
                        <li class="last"><a href="#contact" title="Contact me" class="white"><img src="./img/contact.png" width="32" height="32" alt="Contact me" /></a></li>
                    ...
                    <div class="top_data">
                        <ul class="info">
                            ...
                            <li class="email"><a href="mailto:ahirmayur@gmail.com">ahirmayur@gmail.com</a></li>
